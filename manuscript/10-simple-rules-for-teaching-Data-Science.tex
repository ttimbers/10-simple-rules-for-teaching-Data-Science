...
scaffolding and guidelines that facilitate this. One thing we do in our
courses is establish a course code of conduct, which holds a place of
prevalence in the classroom and related learning spaces. At the
...
what you are trying to teach at that moment. It can also be helpful to
bring in data sets that reflect your learners' local context (e.g.,
country, region, culture) and/or current events to increase engagement
and relevance. It can be difficult to find such data sets in a timely
manner, but it's often worth the effort for learners to connect what
they are learning in their data science course to what's happening in
their own lives and communities outside the classroom.
...
in-class activities, such as think-pair-share and pair programming,
progressing to larger group assignments, and then culminating in
projects. By projects, we mean an entire data product (ideally, on a
topic of their choosing, if feasible) from beginning to end (or from
``nachos to cheesecake,'' to quote Jenny Bryan).
