...
to larger group assignments, and then culminating in projects. By
projects, we mean an entire data product (ideally, on a topic of their
choosing, if feasible) from beginning to end (or from ``nachos to
cheesecake,'' to quote Jenny Bryan).
