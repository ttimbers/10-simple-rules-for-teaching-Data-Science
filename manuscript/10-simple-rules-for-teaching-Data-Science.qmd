...
That is why we believe it is essential to be proactive in establishing norms of behaviour from the outset of a course.
...
this is especially important for the group who are taking the course primarily because it is a degree requirement.
...
In the field of animal behavior across the animal kingdom, repetition is found to lead to learning [@harris1943habituatory; @hebb1949organization].
...
An excellent question instructors may ask in response to reading this rule is "how do we make time in class and across the curriculum for practice as well as knowledge dissemination?" One strategy that we often employ is assigning reading or videos as pre-class homework instead of using the entire class time lecturing for knowledge dissemination.
Allowing time for practice in class is extremely valuable as the instructors and teaching assistants are present to help get students unstuck when they run into struggles.
...
As there is strong evidence that little to no learning happens without practice and repetition, there seems to be little point in teaching topics when there can be no time allotted for practice.
...
Most recently, advances in generative artificial intelligence (AI) have provided another possible tool to provide students with timely feedback: large language models (LLM).
There is much excitement and promise for using LLMs in this way for teaching, as they are more flexible than software tests and have the possibility of providing feedback on narrative and visualizations, in addition to code.
One of the authors of this paper has successfully piloted this recently, and many other educators in many fields are also exploring this (as evidenced by a growing body of literature exploring LLMs in education).
...
The use of LLMs often requires a paid subscription.
In a university setting, unless the institution has a site license or locally hosts open source models and provides unlimited access to them for their students, this can create equity issues for students who cannot afford these tools.
As the tooling around LLMs continues to mature rapidly, instructors who invest in learning about LLMs and how to use them, are likely to find themselves well-positioned to make informed decisions about when and how to adopt these tools as they evolve.
...
Inspiration from this comes from the STA 545 dplyr joins cheat sheet [@bryan2015stat545], which teaches various joins from the dplyr package [@dplyr].
This is a difficult topic for students to wrap their heads around, and when instructors teach it with large data sets, it is really hard for students to see the differences between the types of joins and understand how they work.
...
Educators, like all experts, have blind spots, whereby they tend to teach from the subject's deep principles as opposed to building on the learner's more basic existing knowledge [@nathan2003expert].
...
Beyond accessibility, it is also worth thinking about relevance: varying topics across a course ensures all learners encounter data they find genuinely interesting, and bringing in data that reflects your learners' local context (e.g., country, region, culture) and/or current events can deepen that connection further.
...
Learners also benefit from reviewing the work of others, as they will see examples of things they are working on, some stronger and some are weaker than their own.
This helps them refine their vision for what “good” is for the task they are working on.
...
Practice should occur at increasing levels of complexity, starting with smaller in-class activities, such as think-pair-share [@lyman1981responsive] and pair programming [@HANNAY20091110], progressing to larger group assignments, and then culminating in projects.
...
Beyond Intractability has a useful conflict resolution guide for students doing group projects [@burgess_group_projects].
...
Data science educators need to be actively connected and engaged with the data science communities in some way so they can stay informed about new developments in the field in a timely manner.
There are many ways in which this can be done, including attending in-person or virtual events (e.g., meetups, conferences), reading blogs and preprints and papers, and following data scientists on social media.
...
This allows educators to develop more informed decisions and opinions about the new tool, which they can share with their students when teaching about them.
...
These considerations should be shared with students when teaching new tooling, as well as when asking students not to use particular new tooling, or alternatives to what the most popular mainstream thing may be at the time.

At the time of writing, a timely example is generative artificial intelligence (AI); both chatbots and agentic code-generation tools, which can write, debug, and suggest code.
...
Without staying informed and experimenting with these new generative AI tools, data science educators cannot make educated and good pedagogical choices on how to incorporate them into the classroom and their teaching, nor can they engage students in open, honest discussions about their ethical and practical implications.
