Hello, great. Okay. Hello, everyone. I hope you're enjoying this virtual conference. I'm Wendy Lu,
Professor of Biostatistics at the University of Toronto, Canada. It is my great pleasure to chair
this session sponsored by the Statistical Society of Canada, SSC. Before I start, I'd like to give a
very brief introduction about the speaker, Professor Tiffany Timbers. Tiffany is a faculty
member in the Department of Statistics at the University of British Columbia, I'll briefly
as UBC in Vancouver, Canada. In addition to teaching, she co-directs the master's program
of data science at UBC. Prior to joining UBC as a faculty, she completed her postdoctoral training
at UBC in Simon Fraser University after obtaining her PhD in neuroscience also at UBC. She's a true
Vancouver person. Tiffany is an internationally recognized leader in teaching data science.
She was recently awarded with the SSC's Early Career Educator Award just this year. If you're teaching
courses on data science, I highly recommend you check out her website. She co-authored two textbooks.
One is titled Introduction to Data Science and the other is titled Python Packages. Both are available at
her website and also available as published texts through CRC Press. In the interest of time, for more details
about Tiffany's research interests, publications, and her leadership roles, I will refer you to her website,
which I will send the URLs through the chat shortly. So today, she's going to tell you about
10 simple rules for teaching data science. All right. So over to you, Tiffany.
Tiffany, thank you. Thank you for the introduction, Wendy, and thank you to
the organizers for this great meeting. I'm very honored to be part of it. I'm going to share my screen now
and let me know if that everything looks okay on your end. Yep. Looks great. Excellent.
Excellent. Okay. So as Wendy said, the talk title I have for you today is 10 simple rules for teaching
data science. And so these 10 rules that I'm going to present to you are not rules that I have
necessarily like, I'm not the first person to do this thing, but I'm trying to collate 10, I think,
really good tips, I guess, for teaching that I've seen other people do and then used in the classroom
to with some success. So the first rule that I'm going to talk to you about is teaching data science
by doing data analysis. So what do I mean by this? So I mean, in your first lesson, not in your third
lesson, not in your 10th lesson, not at the end of the semester, but in your first data science lesson,
get the students to load some data, do some mild data wrangling and make a plot. Why do I suggest this?
Because it's extremely motivating to students. In the beginnings, students have signed up to data
to do data analysis or to do data science because they're interested in asking and answering questions
about the world using data. And they don't necessarily have enough knowledge to care deeply
about small things like type and, you know, whether you're using tidyverse versus base R,
whether you're using R versus Python. So get them, show them something interesting early on,
hook them, and then they're going to be begging you to answer those questions for them.
So an example of this is shown in the slide here. So in our first lecture in introduction to data
science, DCI 100 at UBC, and this also comes from the first chapter of the companion textbook for that
data science at first introduction, we get the students to load a data from a CSV, do some light
data wrangling through filtering, arranging and slicing, and then create a plot to answer a question
about indigenous languages in Canada, how, you know, how many of them are there, how many people are
speaking them as their mother tongue. So this is not a new idea for me, as I said, I was first inspired
to do this through following what David Robinson was doing in some of his online courses. He talked about
how it is just so much more intuitive to, you know, use the tidyverse. His case was using the tidyverse to get
students doing things really quickly in a readable way as opposed to base R. That's not the argument
I'm necessarily making today, but his reason for this is you can get people doing interesting things
really quickly. Jenny Bryan, another pretty well-known or extremely well-known data science and R
educator, different software developer, has also tweeted about not front-loading the boring foundational
stuff in courses. So do realistic and non-boring tasks and work your way down to those, the more
boring stuff. Students are going to care about that more boring stuff once they get a bit of experience.
So on each of these slides, you'll kind of see a pattern that I'm going to have some, you know,
if you're really particularly interested in a given rule, you can follow these links and I'll share
a link to my slides at the end of this talk so it'll be easy for you to find these.
...
across the world. The third simple rule that I bring you is giving tons and tons of practice.
...
different aspects of it. Pairing with giving lots of practice, you also want to pair that with tons and
...
real value in these things in the classroom and outside. And finally, my last item on the checklist
...
other people. And here is a QR code that will take you to my talk slides, but I'll also paste those in
the chat. And I'm happy to take any questions if there's time. Awesome. Thank you so much, Tiffany. This
rules that I will hold it close to my heart when I teach my students. Wonderful. Thank you. And we have
about a minute and I think we can take one quick question. Is that right, Jessica? I know there's
another networking session. We'll start by 30, my time. Anyone? Maybe I can ask a quick one. I know that
for intro courses, often students will be coming from various disciplines. Just in terms of the rules
that you have shown us today, are there things you will emphasize, especially students from stats versus,
for example, neuroscience, what are the components that you will emphasize more and be sure that students
are fully aware of and then do follow these rules? Like if your classroom is more diverse,
for example, is that your question? Yeah. So students in stats, they may be interested in
something totally different from students from your science. So if you have all that mixed together
in one class, are there tips that you think you can maybe share with us quickly? Yeah, yeah. I think
using a variety of different types of data sets. So it's really easy, you know, sometimes to fall back on
data sets you're familiar with from your discipline or that you learned when you were going through
education. But if you have a lot of different types of data sets when it comes to toy examples
or those kind of more rich examples, but keeping them still accessible, that gives a little bit for
everybody. So I think that is one thing that I would say. Yeah. Okay, great. Yeah. Very helpful tips.
Thank you. No problem. Okay. So I think our time is up and I wanted to be sure we follow the rules of
on time. Okay. That's all. Thank you so much, Tiffany. And all right. So it's time. I guess I'll hand
over to Jessica and Jane.
