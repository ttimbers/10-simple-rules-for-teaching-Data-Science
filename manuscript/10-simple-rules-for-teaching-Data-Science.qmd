...
We believe these rules are relevant for data science instructors 
teaching in both formal credit courses and workshop settings.
...
Each of these factors independently poses challenges to creating safe, 
inclusive and welcoming learning environments; 
in combination, their effects are compounded.
That is why we believe it is essential to be proactive in establishing norms of behaviour 
...
This means that in your first data science lesson, not your third or 10th lesson, 
have students load data, perform simple data wrangling, and create a data visualization.
...
Most students sign up for a data science course or workshop 
because they're interested in asking and answering questions about the world using data, 
or because it's a degree requirement.
...
this is especially important for the group 
who are taking the course primarily because it is a degree requirement.
...
Other leading data science educators who advocate and practice this rule include Wang and colleagues [-@wang2017data], David Robinson in his introductory online Data Science course [@robinson2017tidyverse; @robinson2017announcing], 
and Jenny Bryan [-@bryan2017twitter], 
a software engineer at Posit (formerly RStudio) and renowned data science educator, 
who summed this up nicely in a tweet "[…] I REPEAT, do not front-load the 'boring', foundational stuff. Do realistic and non-boring tasks and work your way down to it." 
...
An excellent question instructors may ask in response to reading this rule
is "how do we make time in class and across the curriculum 
for practice as well as knowledge dissemination?"
One strategy that we often employ is assigning reading or videos as pre-class homework 
instead of using the entire class time lecturing for knowledge dissemination.
Allowing time for practice in class is extremely valuable 
as the instructors and teaching assistants are present to help get students unstuck 
when they run into struggles.
This is often referred to as flipping the classroom [@King01011993].
We also recommend taking a critical look at the list of topics to be taught
and asking the hard question of what is essential for that course or workshop.
As there is strong evidence that little to no learning happens without 
practice and repetition, 
there seems to be little point in teaching topics 
when there can be no time allotted for practice.
...
Most recently, advances in generative artificial intelligence (AI) 
have provided another possible tool to provide students with timely feedback: 
large language models (LLM).
There is much excitement and promise for using LLMs in this way for teaching, 
as they are more flexible than software tests 
and have the possibility of providing feedback on narrative and visualizations, 
in addition to code.
One of the authors of this paper has successfully piloted this recently,
and many other educators in many fields are also exploring this
(as evidenced by a growing body of literature exploring LLMs in education).
One note of caution for instructors interested in heading out 
on this brave new journey is the high risk of inequitable access to models.
The use of LLMs often requires a paid subscription.
In a university setting, unless the institution has a site license 
or locally hosts open source models and provides unlimited access to them for their students, 
this can create equity issues for students who cannot afford these tools.
As the tooling around LLMs continues to mature rapidly, 
instructors who invest in learning about LLMs and how to use them, 
are likely to find themselves well-positioned to make informed decisions 
about when and how to adopt these tools as they evolve.
This connects naturally to our final rule:
...
Educators, like all experts, have blind spots, 
whereby they tend to teach from the subject's deep principles 
as opposed to building on the learner's more basic existing knowledge [@nathan2003expert].
...
Beyond accessibility, it is also worth thinking about relevance:
varying topics across a course ensures all learners encounter data they find genuinely interesting, and bringing in data that reflects your learners' local context (e.g., country, region, culture) and/or current events can deepen that connection further. 
...
For example, if you decide to teach a data science topic using Anderson's 
well-known iris data set, it is critically important to educate students about the 
first published use of this data set by R. A. Fisher in the Annals of Eugenics [@fisher_use_1936].
There he used the iris data set to advance eugenic methodology.
Thus, the iris data set has a documented history in eugenics research, 
a difficult fact to be addressed and not swept under the rug.
Alternatively, even if educators choose to use a more modern alternative 
(e.g., the Palmer Penguins data set [@horst2020palmerpenguins]),
it is still important to discuss this difficult history of the field.
The history of the field matters regardless of which dataset you use.
Eugenics caused real harm to real people, 
and statistics played a role in that history.
These conversations are not always easy, 
and few of us received explicit training in how to hold them. 
But acknowledging the harm caused by eugenics 
and its place in the history of our field is part of responsible teaching. 
Helping students understand this history 
is how we equip them to think critically about the methods and data they inherit.
It also helps ensure new generations do not repeat mistakes of the past

This rule also applies when teaching a new software tool, 
or a new feature of a tool they are familiar with,
whose design does not seem optimal from the learner's perspective.
Rather than leaving students to feel confused or frustrated, 
it is helpful to explain why the tool was built the way it was.
...
In peer review, 
learners benefit from receiving feedback on their own work before submission. 
This gives them the opportunity to learn and work to improve it. 
Learners also benefit from reviewing the work of others, 
as they will see examples of things they are working on, 
some stronger and some are weaker than their own. 
...
We understand that adding collaboration to an already full curriculum 
requires difficult decisions about what to drop. 
We argue, however, that foundational collaborative skills 
are as important for students as traditional statistical topics, 
...
Practice should occur at increasing levels of complexity, 
starting with smaller in-class activities, 
such as think-pair-share [@lyman1981responsive] 
and pair programming [@HANNAY20091110], 
progressing to larger group assignments, and then culminating in projects.
By projects, we mean an entire data product 
...
During the project, we have them hold regular team check-ins 
(e.g., meetings, written updates, and progress reports) 
and use project boards to track their tasks and progress.
...
Beyond Intractability has a useful conflict resolution guide 
for students doing group projects [@burgess_group_projects].
...
so they can stay informed about new developments in the field in a timely manner.
...
or alternatives to what the most popular mainstream thing may be at the time.
...
S1_File.pdf. Excerpt of the STAT 545 `{dplyr}` joins cheatsheet [@bryan2015stat545].
:::

::: {.supp}
## S2 File. {#s2-file}

S2_File.pdf. Example peer-review checklist for data analysis used in data science courses taught by the authors. 
:::
...
and the students with whom we have tested them in our own classrooms.
