...
To address this issue, Jenny Bryan's cheat sheet uses two constructed toy data sets on superhero comic characters and publishers.
...
S1_File.pdf. Excerpt of the STAT 545 `{dplyr}` joins cheatsheet created by Jenny Bryan.
:::
