...
have the students load some data, perform some simple data wrangling, and create a data visualization.
...
who are taking the course primarily due to it being a degree requirement).
...
This is a difficult topic for students to wrap their heads around, and when instructors teach this with large data sets, it is really hard for students to concretely see the differences between the different types of joins and understand how they work.
...
as opposed to buiding on the learner's more basic existing knowledge [@nathan2003expert].
...
In peer review, 
learners benefit from getting feedback on their own work prior to submission. 
...
some stronger and some weaker than their own. 
...
S2_File.pdf. Example data analysis peer review checklist used in data science courses taught by the authors. 
:::
