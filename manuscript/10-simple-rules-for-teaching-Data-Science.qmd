...
The reason for this is that repetition leads to learning [REFERENCE].
...
repetition leads to learning [REFERENCE]. 
So students really need to do things many, many times to understand 
and then to perform those tasks. 
For example, when I am teaching students to read in data from a file,
I don't just give them one file to read in,
I get them to do this with six different variants of a very similar file. 
The students have to investigate each file in detail, including:
...
Examples include the `{swirl}` R package, 
ADD 2 MORE EXAMPLES HERE.
For those new to designing practice excercises for data science,
I recommend looking at the "Exercise Types" chapter 
