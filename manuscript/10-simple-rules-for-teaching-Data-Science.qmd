...
However, this thought likely stems from the author's deeper understanding of biological processes, which suggests that one needs to understand the data set.
...
Another example, which is more widely used in teaching data science, is the Gapminder data set [@gapminder].
This is a particularly nice example because it contains hundreds of observations; however, the observations are something most people can understand: a country, a year, a population, etc.
...
These lived experiences make us generally knowledgeable and interested in asking questions about the dataset.
...
Creating safe, inclusive, and welcoming learning environments is crucial for effective learning, and as instructors, we have a responsibility to establish scaffolding and guidelines that facilitate this.
